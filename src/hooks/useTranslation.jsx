...
const translations = {
    id: {
        ...
        'bot-pricing-response': 'Paket AI Complete kami tersedia dengan harga Rp. 1.200.000/bulan. Paket ini sudah termasuk semua fitur AI dan Rp 50.000 AI Credit setiap bulannya.',
        'bot-contact-response': 'Anda bisa menghubungi kami melalui email: contact@sellaro.id',
    ...
    en: {
        ...
        'bot-contact-response': 'You can contact us via email: contact@sellaro.id',
